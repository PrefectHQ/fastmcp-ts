...
Defined in: [client/multi-server.ts:47](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/client/multi-server.ts#L47)
...
Defined in: [client/multi-server.ts:50](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/client/multi-server.ts#L50)
...
Defined in: [client/multi-server.ts:42](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/client/multi-server.ts#L42)
...
Defined in: [client/multi-server.ts:61](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/client/multi-server.ts#L61)
