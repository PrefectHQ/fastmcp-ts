...
Defined in: [server/FastMCP.ts:119](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/FastMCP.ts#L119)
...
Defined in: [server/FastMCP.ts:79](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/FastMCP.ts#L79)
