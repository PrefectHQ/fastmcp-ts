...
Defined in: [server/FastMCP.ts:114](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/FastMCP.ts#L114)
...
Defined in: [server/FastMCP.ts:160](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/FastMCP.ts#L160)
...
Defined in: [server/FastMCP.ts:92](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/FastMCP.ts#L92)
