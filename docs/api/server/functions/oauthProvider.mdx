...
Defined in: [server/auth/oauth/provider.ts:34](https://github.com/PrefectHQ/fastmcp-ts/blob/b2d2ea75e5bfae881ff1e471df09a9fe36c6ba70/src/server/auth/oauth/provider.ts#L34)
