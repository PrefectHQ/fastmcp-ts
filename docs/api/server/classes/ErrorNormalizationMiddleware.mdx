...
Defined in: [server/middleware.ts:335](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L335)
...
Defined in: [server/middleware.ts:336](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L336)
