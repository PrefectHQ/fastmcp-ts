...
Defined in: [server/middleware.ts:355](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L355)
...
Defined in: [server/middleware.ts:365](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L365)
...
Defined in: [server/middleware.ts:358](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L358)
