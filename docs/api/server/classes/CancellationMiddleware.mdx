...
Defined in: [server/middleware.ts:375](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L375)
...
Defined in: [server/middleware.ts:385](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L385)
...
Defined in: [server/middleware.ts:378](https://github.com/PrefectHQ/fastmcp-ts/blob/main/src/server/middleware.ts#L378)
