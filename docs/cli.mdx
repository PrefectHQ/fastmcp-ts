...
`install` registers a source file on this machine. To distribute a server, [ship it as a package](/servers/running#ship-as-a-package) that hosts launch with `npx`.
